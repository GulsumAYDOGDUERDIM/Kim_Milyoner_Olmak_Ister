    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            if (kuralCevap != 'E')
            {
                ...
                Console.WriteLine("seyircilerle konuşmak yasaktır.");
                Console.WriteLine("sarular dışarıdan destek alınmadan cevaplanmalıdır");
                Console.WriteLine("telefon kullanmak yasaktır");
